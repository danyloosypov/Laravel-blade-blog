...
<head>
    ...
    <title>{{$metaTitle ?: 'Crazy Blog'}}</title>
    <meta name="author" content="Danylo Osypov">
    ...
    <nav class="w-full py-4 border-t border-b bg-gray-100" x-data="{ open: false }">
        ...
        <div :class="open ? 'block': 'hidden'" class="w-full flex-grow sm:flex sm:items-center sm:w-auto">
            <div class="w-full container mx-auto flex flex-col sm:flex-row items-center justify-between text-sm font-bold uppercase mt-0 px-6 py-2">
                <div class="w-full container mx-auto flex flex-col sm:flex-row items-center text-sm font-bold uppercase mt-0 px-6 py-2"> 
                    ...
                    @auth
                        <div class="flex sm:items-center sm:ml-6">
                            <x-dropdown align="right" width="48">
                                <x-slot name="trigger">
                                    <button class="hover:bg-gray-400 rounded py-2 px-4 mx-2 flex items-center">
