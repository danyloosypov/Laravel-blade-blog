<article class="flex flex-col shadow my-4">
    <!-- Article Image -->
    <a href="{{route('view', $post)}}" class="hover:opacity-75 flex items-center justify-center">
    ...
    <div class="bg-white flex flex-col justify-start p-6">
        ...
        <p href="{{route('view', $post)}}" class="text-sm pb-3">
            By <a href="{{route('view', $post)}}" class="font-semibold hover:text-gray-800">{{$post->user->name}}</a>, Published on {{$post->published_at}}
        </p>
